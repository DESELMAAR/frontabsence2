  ...
  if (isStudent) {
    return (
      <div className="bg-sky-900 bg-opacity-90 backdrop-blur-sm p-6 rounded-xl max-w-3xl mx-auto text-center">
        ...
        <button
          className="btn mt-4 bg-yellow-600 hover:bg-yellow-600 disabled:opacity-60 disabled:cursor-not-allowed"
        ...
        {/* Astuce : tu peux afficher l’id pour debug */}
        {/* <div className="mt-2 text-xs text-white/70">ID: {String(studentId)}</div> */}
      </div>
    );
  }
